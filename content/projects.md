  ...
  <div class="two-column-layout" style="display: flex; margin-top: 50px; justify-content: space-between;">
        <div class="text-column" style="flex: 1; justify-contect; margin-right: 50px;">
            ...
            <ul style="list-style-type: disc; margin-left: -20px; font-size: 0.9em;">
                ...
                <li>Prepared datasets, trained segmentation and ResNet models, and analyzed performance issues such as dataset imbalance and visibility challenges.</li>
                <li>Designed and implemented a 3D calibration system using ArUco markers and camera parameters to convert 2D detections into 3D insertion coordinates.</li>
...
<div class="two-column-layout" style="display: flex; margin-top: 50px; justify-content: space-between;">
        ...
        <div class="video-column" style="flex: 1; margin-top: 30px">
            <a href="/bionic/">
                <img src=https://github.com/user-attachments/assets/1d4bd7ba-325e-4351-aacf-2035eab55e45 alt="Video Thumbnail" style="width: 100%; cursor: pointer;">
            </a>
        </div>
</div>
